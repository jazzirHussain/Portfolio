...
export const metadata = {
  ...
  metadataBase: new URL("https://jazzirhussain.vercel.app"), // Replace with actual domain
  alternates: {
    canonical: "/",
  },
  openGraph: {
    type: "website",
    locale: "en_US",
    url: "https://jazzirhussain.vercel.app",
    ...
    images: [
      {
        url: "https://jazzirhussain.vercel.app/og.png",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://jazzirhussain.vercel.app/og.png"],
...
export default function RootLayout({ children }) {
  const jsonLd = {
    ...
    sameAs: [
      "https://www.linkedin.com/in/jazzir-hussain-7a6b151ab/",
